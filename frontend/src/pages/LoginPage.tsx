        ...
        <div className="grid lg:grid-cols-[0.95fr_1.05fr]">
          <div className="hidden border-r border-white/10 bg-[radial-gradient(circle_at_top,_rgba(46,196,182,0.18),transparent_35%),linear-gradient(180deg,#071117_0%,#0d1820_100%)] p-10 lg:block">
            ...
            <h1 className="mt-10 text-4xl font-semibold tracking-tight text-white">
              Return to your billing command center.
            </h1>
            <p className="mt-5 text-base leading-8 text-slate-300">
              Show live credit balance, recharge flows, autopay readiness, and usage simulation from a single dashboard.
            </p>
            <div className="mt-10 space-y-4">
              {[
                'Recharge plans with Razorpay',
                'Usage history with timestamps and reference IDs',
          ...
          <div className="p-8 sm:p-10 lg:p-12">
            ...
            <div className="mt-8 lg:mt-2">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-400">
                Access the SaaS demo dashboard, wallet, and simulation lab.
              </p>
            </div>
