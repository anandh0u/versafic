        ...
        <div className="grid lg:grid-cols-[1.05fr_0.95fr]">
          <div className="p-8 sm:p-10 lg:p-12">
            ...
            <div className="mt-8">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-400">
                Set up a new account to manage AI calls, chat, wallet balance, and recharge rules.
              </p>
            </div>
          ...
          <div className="hidden border-l border-white/10 bg-[radial-gradient(circle_at_bottom,_rgba(251,191,36,0.18),transparent_34%),linear-gradient(180deg,#0d1820_0%,#071117_100%)] p-10 lg:block">
            <div className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-6">
              <div className="text-xs uppercase tracking-[0.24em] text-slate-500">What you get</div>
              <h3 className="mt-4 text-2xl font-semibold text-white">Everything needed to present the product clearly</h3>
              <div className="mt-6 space-y-4">
                {[
                  ...
                  'Calls, chat, STT, recordings, and onboarding tools in one dashboard',
                ].map((item) => (
